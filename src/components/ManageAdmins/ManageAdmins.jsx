                          ...
                          <li class="mt-2">
                            <div class="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                              <input
                                ...
                                checked={addAdminData.roles.Dashboard}
                                onChange={(e) => {
                          ...
                          <li class="">
                            <div class="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                              <input
                                id="checkbox-item-12"
                                type="checkbox"
                                checked={addAdminData.roles.ManageUsers}
                                onChange={(e) => {
                                  const isChecked = e.target.checked;
                                  setaddAdminData({
                                    ...addAdminData,
                          ...
                          <li>
                            <div class="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                              <input
                                ...
                                type="checkbox"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                checked={addAdminData.roles.ManageAdmins}
                                onChange={(e) => {
                                  const isChecked = e.target.checked;
                                  setaddAdminData({
                                    ...addAdminData,
                          ...
                          <li>
                            <div class="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                              <input
                                ...
                                value=""
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                checked={addAdminData.roles.ManageProducts}
                                onChange={(e) => {
                                  const isChecked = e.target.checked;
                                  setaddAdminData({
                                    ...addAdminData,
                          ...
                          <li>
                            <div class="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                              <input
                                ...
                                type="checkbox"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                checked={addAdminData.roles.ManageOrders}
                                onChange={(e) => {
                                  const isChecked = e.target.checked;
                                  setaddAdminData({
                                    ...addAdminData,
                          ...
                          <li>
                            <div class="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                              <input
                                ...
                                type="checkbox"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                checked={addAdminData.roles.ManageStock}
                                onChange={(e) => {
                                  const isChecked = e.target.checked;
                                  setaddAdminData({
                                    ...addAdminData,
                          ...
                          <li>
                            <div class="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                              <input
                                ...
                                value=""
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                checked={addAdminData.roles.ManageComplaints}
                                onChange={(e) => {
                                  const isChecked = e.target.checked;
                                  setaddAdminData({
                                    ...addAdminData,
