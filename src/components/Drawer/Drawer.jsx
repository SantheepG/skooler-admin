const Drawer = ({view, close}) => {
  return (
    <>
      <div
        id="drawer-right-example"
        className={`transition-transform translate-x-0  ${view ?"animate-slide-in-from-right":"translate-x-full animate-slide-out-to-right"} border-l shadow-lg border-orange-300 fixed  top-20 right-0 z-40 h-screen p-4 overflow-y-auto  bg-white w-[400px] dark:bg-gray-800`}
        tabindex="-1"
