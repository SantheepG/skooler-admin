    ...
    <React.Fragment>
      ...
      {bool ? (
        <>
          ...
          >
            <div className={`p-4 ${overlayClicked ? "opacity-40" : ""}`}>
              <div className="mt-12">
                <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
                  <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                    ...
                    <div className="p-4 text-right">
                      ...
                      <h4 className="block antialiased mt-4 tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                        {productsCnt}
                      </h4>
                    </div>
                  ...
                  <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                    ...
                    <div className="p-4 text-right">
                      ...
                      <h4 className="block antialiased tracking-normal mt-4 font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                ...
                <div className="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
                          ...
                          {holidays.length !== 0 ? (
                            holidays.map((holiday) => (
                              <tr>
                                ...
                                <td className="py-5 px-5 border-b border-blue-gray-50 flex">
                                  <p
                                    className="block antialiased font-sans text-xl hover:text-red-600 cursor-pointer font-medium text-blue-gray-600"
                                    onClick={() => {
                                  ...
                                  {deleteClicked !== null &&
                                    deleteClicked === holiday.id && (
                                      <p
                                        className="block antialiased border ml-6 mt-0.5 absolute rounded-lg px-2 font-sans text-xs hover:text-red-600 hover:border-red-600 cursor-pointer font-medium text-blue-gray-600"
                                        onClick={() =>
                  ...
                  <div className="max-w-md rounded-xl border bg-white p-6 pb-10 text-gray-900">
                    ...
                    <h3 className="font-lg text-sm text-semibold text-center leading-6 text-gray-600">
